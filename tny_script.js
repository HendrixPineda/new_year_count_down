...
//define the function to creat and run the countdown clock

// Funtion to create and run countdown clock
function runClock() {
		...
		// Alternative to above --> newYear.setFullYear(currentDay.getFullyear()+1;
